          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-gray-50/30 focus:outline-none focus:ring-2 focus:ring-purple-500/10 focus:border-purple-300 transition-all text-sm resize-none"
              ></textarea>
            </div>
